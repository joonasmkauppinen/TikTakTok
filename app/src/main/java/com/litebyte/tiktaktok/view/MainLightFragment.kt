...
import kotlinx.android.synthetic.main.fragment_main_light.*
import java.lang.Exception

class MainLightFragment : Fragment(), IFragmentToActivity {

  private lateinit var parentActivity: IGameBoard
  private var difficulty = -1

  companion object {
    fun newInstance(): MainLightFragment {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
    return inflater.inflate(R.layout.fragment_main_light, container, false)
  }
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    // Animate only if changing theme
  ...
  override fun setHorizontalResultLinePosition(bias: Float) {
    ...
    set.clone(board_light)
    set.setVerticalBias(R.id.result_line_horizontal_light, bias)
    set.applyTo(board_light)
  }
  override fun setVerticalResultLinePosition(bias: Float) {
    val set = ConstraintSet()
    set.clone(board_light)
    set.setHorizontalBias(R.id.result_line_vertical_light, bias)
    set.applyTo(board_light)
  }
  override fun paletteButton(): ImageButton {
    return imageButton_palette_light
  }
  override fun difficultyButton(): ImageButton {
    return imageButton_difficulty_light
  }
  override fun statsButton(): ImageButton {
    return imageButton_stats_light
  }
  override fun resultText(): TextView {
    return textView_game_result_light
  }
  override fun playAgainButton(): Button {
    return button_play_again_light
  }
  override fun fadeView(): View {
    return fade_view_light
  }
  override fun resultLineDiagonal(): ImageView {
    return result_line_diagonal_light
  }
  override fun resultLineHorizontal(): ImageView {
    return result_line_horizontal_light
  }
  override fun resultLineVertical(): ImageView {
    return result_line_vertical_light
  }
  override fun difficultyToast(): TextView {
    return textView_difficulty_light
  }

  private fun loadDifficultyAvd(difficulty: Int) {

      when (difficulty) {
        DIFFICULTY_EASY   -> imageButton_difficulty_light.setImageResource(R.drawable.ic_difficulty_easy)
        DIFFICULTY_MEDIUM -> imageButton_difficulty_light.setImageResource(R.drawable.ic_difficulty_medium)
        DIFFICULTY_HARD   -> imageButton_difficulty_light.setImageResource(R.drawable.ic_difficulty_hard)
  ...
  private fun initButtonArray(): ArrayList<ImageButton> {
    ...
    boardButtons.add(button0_light)
    boardButtons.add(button1_light)
    boardButtons.add(button2_light)
    boardButtons.add(button3_light)
    boardButtons.add(button4_light)
    boardButtons.add(button5_light)
    boardButtons.add(button6_light)
    boardButtons.add(button7_light)
    boardButtons.add(button8_light)
    return boardButtons
  }
